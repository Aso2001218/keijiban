...
<body class="bg-teal-400">
    <div class="w-11/12 max-w-screen-md m-auto">
        <!-- title -->
        <h1 class="text-x1 text-lg font-bold mt-5">{{env('app_name')}}</h1>
        {{-- 入力フォーム --}}
        <div class="bg-teal-100 rounded-md mt-5 p-3">
            <form action="{{route('thread.store')}}" method="POST">
                ...
                <div class="flex justify-end mt-2">
                    <input class="px-2 py-1 ml-2 rounded bg-green-600 text-white font-bold link-hover cursor-pointer" type="submit" value="投稿">
                </div>
            </form>
        </div>
        ...
        <div class="bg-teal-100 rounded-md mt-1 mb-5 p-3">
            {{-- スレッド --}}
            <div>
